        ...
        <div class="container-fluid py-5 bg bg-header " style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Artikel/Berita</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <h4 class="mb-3">Presiden Jokowi datang ke Ponpes Cipasung</h4>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#"><i class="bi bi-arrow-right me-2"></i>Artikel</a>
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#"><i class="bi bi-arrow-right me-2"></i>Berita</a>
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#"><i class="bi bi-arrow-right me-2"></i>Kegiatan</a>
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#"><i class="bi bi-arrow-right me-2"></i>Prestasi</a>
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#"><i class="bi bi-arrow-right me-2"></i>Lainnya</a>
                        </div>
                    </div>
                    <!-- Category End -->
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Keagamaan</a>
                            <a href="" class="btn btn-light m-1">Kegiatan</a>
                            <a href="" class="btn btn-light m-1">Prestasi</a>
                            <a href="" class="btn btn-light m-1">PHBN</a>
                            <a href="" class="btn btn-light m-1">PHBI</a>
